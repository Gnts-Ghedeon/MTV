...
-- Dumping database structure for mytv
...
-- Dumping structure for table mytv.actor_director
...
-- Dumping data for table mytv.actor_director: ~223 rows (approximately)
REPLACE INTO `actor_director` (`id`, `ad_type`, `ad_name`, `ad_slug`, `ad_image`) VALUES
...
-- Dumping structure for table mytv.app_ads
...
-- Dumping data for table mytv.app_ads: ~5 rows (approximately)
REPLACE INTO `app_ads` (`id`, `ads_name`, `ads_info`, `status`) VALUES
...
-- Dumping structure for table mytv.channels_list
...
-- Dumping data for table mytv.channels_list: ~25 rows (approximately)
REPLACE INTO `channels_list` (`id`, `channel_cat_id`, `channel_access`, `channel_name`, `channel_slug`, `channel_description`, `channel_thumb`, `channel_url_type`, `channel_url`, `channel_url2`, `channel_url3`, `seo_title`, `seo_description`, `seo_keyword`, `views`, `status`) VALUES
...
-- Dumping structure for table mytv.channel_category
...
-- Dumping data for table mytv.channel_category: ~5 rows (approximately)
REPLACE INTO `channel_category` (`id`, `category_name`, `category_slug`, `status`) VALUES
...
-- Dumping structure for table mytv.coupons
...
-- Dumping data for table mytv.coupons: ~0 rows (approximately)

-- Dumping structure for table mytv.episodes
...
-- Dumping structure for table mytv.genres
...
-- Dumping data for table mytv.genres: ~9 rows (approximately)
REPLACE INTO `genres` (`id`, `genre_name`, `genre_slug`, `status`) VALUES
	(1, 'Drama', 'drama', 1),
	(2, 'Action', 'action', 1),
	(3, 'Comedy', 'comedy', 1),
...
-- Dumping structure for table mytv.home_sections
...
-- Dumping data for table mytv.home_sections: ~6 rows (approximately)
REPLACE INTO `home_sections` (`id`, `section_name`, `section_slug`, `post_type`, `movie_ids`, `show_ids`, `sport_ids`, `tv_ids`, `status`) VALUES
...
-- Dumping structure for table mytv.language
...
-- Dumping data for table mytv.language: ~6 rows (approximately)
REPLACE INTO `language` (`id`, `language_name`, `language_slug`, `language_image`, `status`) VALUES
...
-- Dumping structure for table mytv.movie_videos
...
-- Dumping structure for table mytv.pages
...
-- Dumping data for table mytv.pages: ~5 rows (approximately)
REPLACE INTO `pages` (`id`, `page_title`, `page_slug`, `page_content`, `page_order`, `status`) VALUES
...
-- Dumping structure for table mytv.password_resets
...
-- Dumping data for table mytv.password_resets: ~0 rows (approximately)

-- Dumping structure for table mytv.payment_gateway
...
-- Dumping data for table mytv.payment_gateway: ~10 rows (approximately)
REPLACE INTO `payment_gateway` (`id`, `gateway_name`, `gateway_info`, `status`) VALUES
	(1, 'Paypal', '{"mode":"sandbox","paypal_client_id":null,"paypal_secret":null,"braintree_merchant_id":null,"braintree_public_key":null,"braintree_private_key":null,"braintree_merchant_account_id":null}', 0),
...
-- Dumping data for table mytv.payu_transactions: ~0 rows (approximately)

-- Dumping structure for table mytv.recently_watched
...
-- Dumping data for table mytv.recently_watched: ~3 rows (approximately)
REPLACE INTO `recently_watched` (`id`, `video_type`, `user_id`, `video_id`) VALUES
	(1, 'LiveTV', 2, 26),
	(2, 'LiveTV', 2, 8),
	(3, 'Movies', 2, 43);

-- Dumping structure for table mytv.season
...
-- Dumping data for table mytv.season: ~28 rows (approximately)
REPLACE INTO `season` (`id`, `series_id`, `season_name`, `season_slug`, `season_poster`, `trailer_url`, `seo_title`, `seo_description`, `seo_keyword`, `status`) VALUES
...
-- Dumping structure for table mytv.series
...
-- Dumping data for table mytv.series: ~20 rows (approximately)
REPLACE INTO `series` (`id`, `series_lang_id`, `series_genres`, `upcoming`, `series_access`, `series_name`, `series_slug`, `series_info`, `actor_id`, `director_id`, `series_poster`, `imdb_id`, `imdb_rating`, `imdb_votes`, `seo_title`, `seo_description`, `seo_keyword`, `content_rating`, `status`) VALUES
...
-- Dumping structure for table mytv.settings
...
-- Dumping structure for table mytv.settings_android_app
CREATE TABLE IF NOT EXISTS `settings_android_app` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table mytv.settings_android_app: ~0 rows (approximately)
REPLACE INTO `settings_android_app` (`id`, `app_name`, `app_logo`, `app_version`, `app_company`, `app_email`, `app_website`, `app_contact`, `app_about`, `app_privacy`, `app_terms`, `onesignal_app_id`, `onesignal_rest_key`, `app_update_hide_show`, `app_update_version_code`, `app_update_desc`, `app_update_link`, `app_update_cancel_option`) VALUES
...
-- Dumping structure for table mytv.settings_player
CREATE TABLE IF NOT EXISTS `settings_player` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table mytv.settings_player: ~0 rows (approximately)
REPLACE INTO `settings_player` (`id`, `player_style`, `player_watermark`, `player_logo`, `player_logo_position`, `player_url`, `autoplay`, `pip_mode`, `rewind_forward`, `player_ad_on_off`, `ad_offset`, `ad_skip`, `ad_web_url`, `ad_video_type`, `ad_video_url`) VALUES
...
-- Dumping structure for table mytv.slider
...
-- Dumping data for table mytv.slider: ~5 rows (approximately)
REPLACE INTO `slider` (`id`, `slider_title`, `slider_image`, `slider_type`, `slider_post_id`, `slider_display_on`, `slider_url`, `status`) VALUES
...
-- Dumping structure for table mytv.sports_category
...
-- Dumping data for table mytv.sports_category: ~8 rows (approximately)
REPLACE INTO `sports_category` (`id`, `category_name`, `category_slug`, `status`) VALUES
	(8, 'Archery', 'archery', 1),
...
-- Dumping structure for table mytv.sports_videos
...
REPLACE INTO `sports_videos` (`id`, `video_access`, `sports_cat_id`, `video_title`, `date`, `duration`, `video_description`, `video_slug`, `video_image`, `video_type`, `video_quality`, `video_url`, `video_url_480`, `video_url_720`, `video_url_1080`, `download_enable`, `download_url`, `subtitle_on_off`, `subtitle_language1`, `subtitle_url1`, `subtitle_language2`, `subtitle_url2`, `subtitle_language3`, `subtitle_url3`, `seo_title`, `seo_description`, `seo_keyword`, `views`, `status`, `created_at`, `updated_at`) VALUES
	...
	(14, 'Free', 9, 'Thalaivas 39-31 Titans', 0, NULL, '<div class=\\"description\\">Tamil Thalaivas flipped the script on bottom-placed Telugu Titans in a closely-fought Southern Derby in vivo Pro Kabaddi 2022</div>', 'thalaivas-39-31-titans', 'upload/images/Pro_Kabaddi.jpg', 'Local', 0, 'upload/files/dolbycanyon_mkv.mkv', NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', 2, 1, NULL, '2022-11-16 10:17:54'),
	...
	(20, 'Free', 16, 'Jai Ho! A Tokyo Games Special', 0, NULL, '<div class=\\"description\\">Catch a special series featuring India\\\'s medal winners at the Tokyo Games 2020, where the Indian contingent picked up a record 7 medals</div>', 'jai-ho-a-tokyo-games-special', 'upload/images/catch_special_series_medals.jpg', 'Local', 0, 'upload/files/dolbycanyon_mkv.mkv', NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', 5, 1, NULL, '2022-11-10 07:54:00'),
...
-- Dumping structure for table mytv.subscription_plan
...
-- Dumping data for table mytv.subscription_plan: ~4 rows (approximately)
REPLACE INTO `subscription_plan` (`id`, `plan_name`, `plan_days`, `plan_duration`, `plan_duration_type`, `plan_price`, `status`) VALUES
	(1, 'Basic Plan', 7, '7', '1', 10.00, 1),
	(2, 'Premium Plan', 30, '1', '30', 29.00, 1),
	(3, 'Platinum Plan', 365, '1', '365', 99.00, 1),
	(4, 'Free Plan', 1, '1', '1', 0.00, 1);

-- Dumping structure for table mytv.transaction
...
-- Dumping data for table mytv.transaction: ~1 rows (approximately)
REPLACE INTO `transaction` (`id`, `user_id`, `email`, `plan_id`, `gateway`, `payment_amount`, `payment_id`, `date`) VALUES
	(1, 2, 'smethdev@gmail.com', 4, 'NA', '0.00', '-', 1702982351);

-- Dumping structure for table mytv.users
...
-- Dumping data for table mytv.users: 2 rows
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `usertype`, `login_status`, `google_id`, `facebook_id`, `name`, `email`, `password`, `phone`, `user_address`, `user_image`, `status`, `plan_id`, `start_date`, `exp_date`, `plan_amount`, `confirmation_code`, `remember_token`, `session_id`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', 0, NULL, NULL, 'Viavi Webtech', 'admin@admin.com', '$2y$10$EMeDkbAwIXJd7fAX0pWF2OZCHmKuGMwtD3ZUjg9HEOMvkaVl.5Xvm', '9227777522', NULL, 'viavi-webtech-1f2416ecff3faba4159de6b399477081-b.jpg', 1, 2, 0, 2592000, '0.00', NULL, 'MUjf7JTf42GV3hEJiLukfUexYCYJ2tjbkdfkjl4x0uLgRRVNlW3XOeC0yJPg', 'iXL5Efee1FhfiXQzxPTe2PzEfFqU3seM3b6TzvU7', '2020-03-12 03:16:45', '2022-12-12 04:33:10'),
	(2, 'User', 0, NULL, NULL, 'smeth', 'smethdev@gmail.com', '$2y$10$2nSljjo3gWVRaIPrCos2eOXH1myR3GuVw3uk9wliGk4btKWFfxX8.', NULL, NULL, NULL, 1, 4, 1702924200, 1703010600, '0.00', NULL, NULL, NULL, '2023-12-19 15:07:36', '2023-12-19 15:09:11');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- Dumping structure for table mytv.watchlist
...
-- Dumping data for table mytv.watchlist: ~13 rows (approximately)
REPLACE INTO `watchlist` (`id`, `user_id`, `post_id`, `post_type`) VALUES
	(3, 1, 1, 'Sports'),
	(4, 1, 14, 'Movies'),
	(5, 8, 1, 'Sports'),
	(6, 8, 1, 'LiveTV'),

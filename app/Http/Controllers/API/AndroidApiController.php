    ...
    public function home()
    {
        ...
        foreach($home_sections as $sections_data)
        {
            if($sections_data->post_type=="Movie")
            {
                ...
                {
                    if(Movies::getMoviesInfo($movie_data,'status')==1)
                    {
                        $video_id=$movie_data;
                        $video_type="Movie";
            ...
            if($sections_data->post_type=="Shows")
            {
                ...
                {
                    if(Series::getSeriesInfo($show_data,'status')==1)
                    {
                        $video_id=$show_data;
                        $video_type="Shows";
            ...
            if($sections_data->post_type=="Sports")
            {
                ...
                {
                    if(Sports::getSportsInfo($sport_data,'status')==1)
                    {
                        $video_id=$sport_data;
                        $video_type="Sports";
            ...
            if($sections_data->post_type=="LiveTV")
            {
                ...
                {
                    if(LiveTV::getLiveTvInfo($tv_data,'status')==1)
                    {
                        $video_id=$tv_data;
                        $video_type="LiveTV";

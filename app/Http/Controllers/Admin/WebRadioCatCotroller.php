...
use App\RadioCategory as AppRadioCategory;
use Illuminate\Http\Request;

class WebRadioCatCotroller extends MainAdminController
{
    ...
    public function genres_list()    {
        ...
        $page_title= "Categorie Radio"; //trans('words.genres_text');

        $genres_list = AppRadioCategory::orderBy('category_name')->paginate(10);

...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 20 déc. 2023 à 18:19
...
--
-- Base de données : `mytv`
--

-- --------------------------------------------------------

--
-- Structure de la table `actor_director`
--
...
--
-- Déchargement des données de la table `actor_director`
--
...
--
-- Déchargement des données de la table `app_ads`
--
...
--
-- Structure de la table `channels_list`
--
...
--
-- Déchargement des données de la table `channels_list`
--
...
--
-- Structure de la table `channel_category`
--
...
--
-- Déchargement des données de la table `channel_category`
--
...
--
-- Structure de la table `movie_videos`
--
...
--
-- Déchargement des données de la table `movie_videos`
--
...
--
-- Structure de la table `payment_gateway`
--
...
--
-- Déchargement des données de la table `payment_gateway`
--
...
--
-- Structure de la table `podcats`
--

DROP TABLE IF EXISTS `podcats`;
CREATE TABLE IF NOT EXISTS `podcats` (
...
--
-- Structure de la table `recently_watched`
--
...
--
-- Déchargement des données de la table `recently_watched`
--
...
--
-- Déchargement des données de la table `settings_android_app`
--
...
--
-- Structure de la table `settings_player`
--
...
--
-- Déchargement des données de la table `settings_player`
--
...
--
-- Structure de la table `sports_category`
--
...
--
-- Déchargement des données de la table `sports_category`
--
...
--
-- Structure de la table `sports_videos`
--
...
--
-- Déchargement des données de la table `sports_videos`
--
...
(3, 'Admin', 0, NULL, NULL, 'smeth', 'smethturk@gmail.com', '$2y$10$WX3DOlXVQvK4sgV7N.ccCu5UKDnEnOjJ529K42yCouOsX0YCcFx6q', NULL, NULL, 'smeth-1f4278ef407425b74f3182b0b678a5b3-b.jpg', 1, 0, NULL, NULL, '0', NULL, NULL, NULL, '2023-12-19 17:07:05', '2023-12-19 17:07:05');
